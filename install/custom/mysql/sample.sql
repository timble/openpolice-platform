...
INSERT INTO `press` (`press_article_id`, `title`, `slug`, `text`, `published`, `published_on`, `created_on`, `created_by`, `modified_on`, `modified_by`, `locked_by`, `locked_on`, `publish_on`, `params`)
VALUES
	(1, 'Sit Mattis Cursus', 'sit-mattis-cursus', '<p>Nullam id dolor id nibh ultricies vehicula ut id elit. Aenean lacinia bibendum nulla sed consectetur. Etiam porta sem malesuada magna mollis euismod. Donec id elit non mi porta gravida at eget metus.</p>\r\n\r\n<p>Donec ullamcorper nulla non metus auctor fringilla. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean eu leo quam.</p>', 1, '2014-06-27 13:17:00', '2014-06-27 13:17:00', 3, '2014-06-27 13:29:11', 3, NULL, NULL, NULL, NULL),
	(2, 'Fermentum Purus Cursus Consectetur', 'fermentum-purus-cursus-consectetur', '<p>Nullam id dolor id nibh ultricies vehicula ut id elit. Aenean lacinia bibendum nulla sed consectetur. Etiam porta sem malesuada magna mollis euismod. Donec id elit non mi porta gravida at eget metus.</p>\r\n\r\n<p>Donec ullamcorper nulla non metus auctor fringilla. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean eu leo quam.</p>', 1, '2014-06-27 13:24:00', '2014-06-27 13:24:00', 3, NULL, 0, 3, '2014-06-27 13:25:50', NULL, NULL),
	(3, 'Condimentum Commodo', 'condimentum-commodo', '<p>Curabitur blandit tempus porttitor. Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Curabitur blandit tempus porttitor. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec sed odio dui.</p>', 1, '2014-06-27 13:26:00', '2014-06-27 13:26:00', 3, NULL, 0, NULL, NULL, NULL, NULL);
