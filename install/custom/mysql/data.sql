...
VALUES
	...
	(36,1,0,'Questions','questions','option=com_questions&view=categories',NULL,'component',1,0,0,40,1,'2013-04-28 19:37:58',NULL,NULL,NULL,NULL,0,'page_title=\"Veelgestelde vragen\"'),
	...
	(108, 1, 0, 'Search', 'search', 'option=com_questions&view=questions&layout=search', NULL, 'component', 1, 1, 0, 40, 1, '2014-10-16 14:38:09', NULL, NULL, NULL, NULL, 0, 'page_title=\"\"'),
	...
	(110, 1, 0, 'Controles', 'controles', 'option=com_traffic&view=articles&category=19', NULL, 'component', 1, 0, 0, 37, 1, '2014-12-01 17:28:27', NULL, NULL, NULL, NULL, 0, 'page_title=\"\"'),
	(111, 1, 0, 'Events', 'events', 'option=com_traffic&view=articles&category=21', NULL, 'component', 1, 0, 0, 37, 1, '2014-12-01 17:28:27', NULL, NULL, NULL, NULL, 0, 'page_title=\"\"'),
	(112, 1, 0, 'Measures', 'measures', 'option=com_traffic&view=articles&category=22', NULL, 'component', 1, 0, 0, 37, 1, '2014-12-01 17:28:27', NULL, NULL, NULL, NULL, 0, 'page_title=\"\"'),
	(113, 1, 0, 'Roadblocks', 'roadblocks', 'option=com_traffic&view=articles&category=20', NULL, 'component', 1, 0, 0, 37, 1, '2014-12-01 17:28:27', NULL, NULL, NULL, NULL, 0, 'page_title=\"\"'),
	(114, 1, 0, 'Results', 'results', 'option=com_traffic&view=articles&category=19&layout=results&results=true', NULL, 'component', 1, 1, 0, 37, 1, '2014-12-01 17:28:27', NULL, NULL, NULL, NULL, 0, 'page_title=\"\"'),
	...
	(118, 1, 0, 'Found', 'found-items', 'option=com_found&view=items', NULL, 'component', 1, 1, 0, 48, 1, '2015-01-30 15:48:04', NULL, NULL, NULL, NULL, 0, 'page_title=\"\"');
...
VALUES
	...
	(36, 00000000011, 00000000004),
	(37, 00000000006, 00000000002),
	(39, 00000000010, 00000000005),
	(40, 00000000007, 00000000006),
	(41, 00000000001, 00000000007),
...
INSERT INTO `data`.`police_zones` (`police_zone_id`, `titles`, `language`, `phone_emergency`, `phone_information`, `email`, `twitter`, `facebook`, `created_by`, `created_on`, `modified_by`, `modified_on`, `locked_by`, `locked_on`)
VALUES
