...
INSERT INTO `data`.`police_zones` (`police_zone_id`, `title-old`, `language`, `phone_emergency`, `phone_information`, `email`, `twitter`, `facebook`, `created_by`, `created_on`, `modified_by`, `modified_on`, `locked_by`, `locked_on`)
VALUES
