...
CREATE TABLE `streets_streets_islps` LIKE `streets`; INSERT `streets_streets_islps` SELECT * FROM `streets`;
...
DELETE FROM `streets_streets_islps` WHERE `islp` IS NULL;
...
ALTER TABLE `streets` ADD UNIQUE INDEX (`identifier`, `iso`, `sources_source_id`);
