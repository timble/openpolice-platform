...
<fieldset>
    ...
    <div>
        ...
        <div>
            <input type="date" name="created_on" value="<?= helper('date.format', array('date'=> $article->start_on, 'format' => 'Y-m-d')) ?>" />
        </div>
    </div>
    <div>
        <label for="date">
        ...
        <div>
            <input type="date" name="created_on" value="<?= helper('date.format', array('date'=> $article->end_on, 'format' => 'Y-m-d')) ?>" />
        </div>
    </div>
</fieldset>
<fieldset>
