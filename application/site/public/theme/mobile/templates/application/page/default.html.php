    ...
    <div class="section-header">
        <div class="row-fluid">
            ...
            <div class="span9 navbar navbar-responsive">
                ...
                <span class="slogan hidden-phone">Bel <strong>112</strong> als elke seconde telt. Geen spoed, wél politie? Bel <strong><?= @escape($zone->telephone); ?></strong></span>
...
<div class="container copyright">
    ...
    <div class="span6 text-right">
        <ul>
            <li>© 2013 Lokale Politie - <?= @escape($zone->title); ?></li>
            ...
            <li><a target="_blank" href="http://www.belgium.be"><image src="media://application/images/icon_belgium.gif" /></a></li>
        </ul>
    </div>
</div>
