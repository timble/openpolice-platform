INSERT INTO `fora_categories` (`fora_category_id`, `parent_id`, `attachments_attachment_id`, `title`, `slug`, `image`, `table`, `description`, `published`, `created_by`, `created_on`, `modified_by`, `modified_on`, `locked_by`, `locked_on`, `ordering`, `access`, `params`)
VALUES
	(1, 0, 0, 'Docman Forum', '', '', 'fora_forums', '', 1, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, '');


INSERT INTO `fora_forums` (`fora_forum_id`, `fora_category_id`, `type`, `title`, `slug`, `text`, `ordering`, `published`, `created_on`, `created_by`, `modified_on`, `modified_by`, `locked_on`, `locked_by`)
VALUES
	(1, 1, 'issue', 'article', 'article', '<p>sdfasfasdf</p>\r\n', 0, 1, '2013-10-07 18:36:04', 1, '2013-10-07 16:43:42', 1, NULL, NULL),
	(2, 1, 'issue', 'Issue', 'issue', '', 0, 1, NULL, NULL, NULL, NULL, NULL, NULL),
	(3, 1, 'question', 'questions', 'question', '', 0, 1, NULL, NULL, NULL, NULL, NULL, NULL),
	(4, 1, 'idea', 'idea', 'idea', '', 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
